...
import OrderTaskTable from './task/OrderTaskTable';
...
class orderForm extends Component {
  ...
  handleNext = () => {
    ...
    if (stepIndex >= 2) {
      this.actions()
        .validate(orderRequiredFieldList.toArray());
      if (!this.properties()
        .validations
        .find((v) => {
  ...
  autocomplete(fieldName, validateFields, hintText, data, toString, rest) {
    ...
    return (
      <AutoComplete
        ...
        dataSource={data()
          .map((r) => H.autoCompleteItem(toString, r))}
        openOnFocus={true}
